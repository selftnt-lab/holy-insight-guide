    ...
    <Fragment>
      <header className="fixed left-0 right-0 top-0 z-50 flex items-center justify-center border-b border-border/50 bg-background/85 px-5 py-3 backdrop-blur-md">
        <div className="flex flex-col items-center">
          <img
            src={rcLogo.url}
            className="h-16 w-auto object-contain transition-all duration-700 hover:scale-105 mix-blend-multiply dark:mix-blend-lighten brightness-[1.1] contrast-[1.1] dark:brightness-[1.5] dark:contrast-[1.2] drop-shadow-[0_4px_10px_rgba(0,0,0,0.1)] dark:drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]"
            style={{ 

...
export const EmailChangeEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Confirme a troca do seu e-mail na {APP_NAME}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Text style={brand}>{APP_NAME}</Text>
        <Heading style={h1}>Confirme a troca do seu e-mail</Heading>
        <Text style={text}>
          Você solicitou trocar o e-mail da sua conta na {APP_NAME} de{' '}
        ...
        <Text style={footer}>
          Se você não solicitou esta mudança, proteja sua conta imediatamente redefinindo a senha.
        </Text>
      </Container>
    </Body>
  </Html>
